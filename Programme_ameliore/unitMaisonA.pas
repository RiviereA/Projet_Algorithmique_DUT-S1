...
interface
  uses GestionEcran, PersonnageUnitA,depotA,retraitA,craftA,cavePot ;
...
begin
      ...
      writeln('4-Crafter');
      writeln('5-Explorer la cave. *depuis quand avez vous une cave ?*');
      writeln('6-Sortir de la maison');
		  readln(choix);
      effacerEcran;
	    case choix of
			1:begin
